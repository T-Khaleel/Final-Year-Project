...
t=time.time()
#Reading the dataset
app=pd.read_csv('8Appliance.csv').dropna()
app.head()
...
(I_tr, I_ts, O_tr, O_ts)=train_test_split(I,O, test_size=0.25)
...
joblib.dump(model, 'KNN.pkl') #Saving Model

model=joblib.load('KNN.pkl') #loading saved model  
